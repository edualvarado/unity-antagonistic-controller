/****************************************************
 * File: InterpolationSkeletonsV3.cs
...
public class InterpolationSkeletonsV3 : MonoBehaviour
{
    // --- NEW --- //
    ...
    private SetSkeletonsV3 _setSkeletons;
    ...
    [Header("Debug")]
    public bool fixLeftArmKinematic = false;
    public bool fixRightArmKinematic = false;
    ...
    void Start()
    {
        ...
        _setSkeletons = FindObjectOfType<SetSkeletonsV3>();
    ...
    void FixedUpdate()
    {
        ...
        fixLeftArmKinematic = !interpolateLeftArm;
        fixRightArmKinematic = !interpolateRightArm;

        if (fixLeftArmKinematic)
            FixLeftArm();

        if (fixRightArmKinematic)
            FixRightArm();
    ...
    private void InitialMatch()
    {
        ...
        for (int i = 0; i < SetSkeletonsV3.AboveAnchorLength; i++)
        {
    ...
    private void BlendingKeyLowerBodyVariableAnchorMethod()
    {
        ...
        {
            for (int i = 0; i < SetSkeletonsV3.BelowAnchorLength; i++)
            {
