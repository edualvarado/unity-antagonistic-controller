...
public class IKFeetPlacement : MonoBehaviour
{
    ...
    */
    ...
    private void CheckFeetAreGrounded()
    {
        ...
        {
            Debug.DrawRay(groundCheckerLeftFootFront.position, -Vector3.up * feetToGroundDistance, Color.white);
            Debug.DrawRay(groundCheckerLeftFootBack.position, -Vector3.up * feetToGroundDistance, Color.white);
            Debug.DrawRay(groundCheckerRightFootFront.position, -Vector3.up * feetToGroundDistance, Color.white);
